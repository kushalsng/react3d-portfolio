...
const ServiceCard = ({index, service, title, icon}) => {
  return (
  ...
  return (
    <>
      ...
      >
        ...
        Java, and expertise in frameworks like React, Spring, and
        cloud-native application like Docker, AWS, Azure, GCP. I'm a quick learner
